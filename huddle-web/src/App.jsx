...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col items-center">
      <header className="w-full bg-gray-900/80 backdrop-blur-md p-4 sticky top-0 z-50 border-b border-gray-800">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <nav className="flex items-center gap-6">
            <Link to="/" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">Lobbies</Link>
              ...
              <div className="flex items-center gap-4">
                <Link to="/profile" className="flex items-center gap-2 group">
                  <img 
                    ...
                    alt="avatar" 
                    className="w-8 h-8 rounded-full border border-gray-700 group-hover:border-blue-400 transition-colors bg-gray-800"
                  />
